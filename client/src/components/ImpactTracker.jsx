...
export default function ImpactTracker() {
    ...
    return (
        <section className="py-16 bg-blue-600 text-white relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-72 h-72 bg-blue-500/30 rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2"></div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl text-center border border-white/20 hover:bg-white/20 hover:scale-105 transition-all duration-300 cursor-default group">
                        ...
                        <p className="text-blue-200 font-medium">Total Funds Raised</p>
                    </div>
                    ...
                    <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl text-center border border-white/20 hover:bg-white/20 hover:scale-105 transition-all duration-300 cursor-default group">
                        ...
                        <p className="text-blue-200 font-medium">Successful Donations</p>
                    </div>
                    ...
                    <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl text-center border border-white/20 hover:bg-white/20 hover:scale-105 transition-all duration-300 cursor-default group">
                        ...
                        <p className="text-blue-200 font-medium">Unique Donors</p>
                    </div>
                </div>
            </div>
        </section>
